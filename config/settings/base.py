...
SPECTACULAR_SETTINGS = {
    ...
    "TAGS": [
        ...
        },
        {
            ...
            "description": (
                "Проверка финансового здоровья: справочник метрик, расчёт общего "
                "score, уровней риска, агрегированных показателей и rule-based "
                "рекомендаций по данным текущего пользователя."
            ),
        },
        {
            "name": "finance-sync",
