...
SPECTACULAR_SETTINGS = {
    ...
    "TAGS": [
        ...
        },
        {
            "name": "finance-sync",
            "description": (
                "Оффлайн-синхронизация: meta-параметры, начальный снимок данных, "
                "получение изменений после последней синхронизации и batch-отправка "
                "оффлайн-операций с идемпотентностью по clientMutationId."
            ),
        },
        {
