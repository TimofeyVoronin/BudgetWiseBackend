...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        ...
        "управления профилем, финансовыми счетами, бюджетами, валютами, тегами операций, финансовыми целями, уведомлениями, регулярными операциями, планируемыми операциями, "
        ...
        },
{
    ...
    "description": (
        ...
        },
        {
            ...
            "description": (
                "Управление валютами: список доступных валют, каталог, "
                "пользовательские валюты, основная валюта, видимость валют "
                "в интерфейсе и справочники для форм."
            ),
        },
        {
            "name": "finance-tags",
