...
from apps.finance.currencies.services import get_user_currencies
...
class FinanceCurrencyRatesAPITests(FinanceAPITestCase):
    ...
    @patch("apps.finance.currencies.rates.fetch_crypto_rub_values")
    @patch("apps.finance.currencies.rates.fetch_cbr_rub_values")
